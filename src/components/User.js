...
const User = ({user, deleteUser, department, onDepartment}) => {
	...
	const handleAdd =(id) => {
			console.log("data: ", {data: {department: department.department, userId: id}})
			Axios.post('http://20.71.162.122:8080/department', {department: department.department, userId: id})
